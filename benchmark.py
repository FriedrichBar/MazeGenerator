...
def DFS(L, l):
    ...
    while len(stack) != 0:
        ...
        # Sinon il faut "backtrack"
            ...
            if len(stack) != 0:
                celluleActuelle = stack[-1]
    print("L:",L,"l:",l,"N:",L*l,"Temps:%s secondes" % (time.time()-start),"N/Temps:",(L*l)/(time.time()-start))
    return Labyrinthe, celluleDepart

Labyrinthe, celluleDepart = DFS(5, 5)
Labyrinthe, celluleDepart = DFS(25, 25)
Labyrinthe, celluleDepart = DFS(50, 50)
Labyrinthe, celluleDepart = DFS(75, 75)
Labyrinthe, celluleDepart = DFS(100, 100)
Labyrinthe, celluleDepart = DFS(150, 150)
Labyrinthe, celluleDepart = DFS(175, 175)
Labyrinthe, celluleDepart = DFS(200, 200)
Labyrinthe, celluleDepart = DFS(250, 250)
Labyrinthe, celluleDepart = DFS(300, 300)
Labyrinthe, celluleDepart = DFS(500, 500)
Labyrinthe, celluleDepart = DFS(750, 750)
Labyrinthe, celluleDepart = DFS(1000, 1000)